...
const Invoice = () => {
  ...
  return (
    <div className="invoice-container border-2 border-red-500 w-full h-[100vh] p-12 flex items-center justify-center">
      <div className="border-2 border-red-500 w-[80%] h-full">
            ...
            <tbody>
              {rows.map((row, index) => (
                <tr key={index}>
                  ...
                  <td className="border-2 border-red-500 text-center p-2 text-xl">
                    <select
                      className="border-2 border-cyan-500 text-xl p-1"
                      value={row.name}
                      onChange={(e) =>
