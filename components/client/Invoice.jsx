...
const Invoice = ({ packages, coupons }) => {
              ...
              <div className="flex flex-col lg:flex-col items-start lg:items-center justify-between">
                ...
                <div className="flex flex-wrap mb-4 lg:mb-0 w-[97%]">
                  ...
                  <div className="flex flex-wrap mt-4 lg:mt-0 lg:ml-auto">
                    ...
                    <button
                      className="ml-2 text-lg sm:text-xl lg:text-2xl py-2 px-4 bg-cyan-600 text-white rounded-md shadow-md hover:bg-cyan-700 mb-2 lg:mb-0"
                      onClick={applyCoupon}
                    >
                      Apply Coupon
                    </button>
                ...
                <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between w-full lg:w-[97%] mt-2">
                  ...
                  <div className="text-lg sm:text-xl lg:text-2xl font-medium mb-4 lg:mb-0">
                   <div className="text-sm lg:text-xl"> Gross Amount: ${(totalAmount + discountedAmount).toFixed(2)}</div>
                    {appliedCoupon && (
                      <div className="text-sm lg:text-lg mt-1 text-red-600">
